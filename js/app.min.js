...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/frk.jpg" alt="Ricko Najmudin"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Ricko Najmudin</td></tr>
					...
					<tr><td>Portfolio</td><td><a href="https://my-portofolio-rick.vercel.app/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:rickonajmudin@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="#"><i class="fab fa-skype"></i></a>
              <a href="#"><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/RickNazmudin" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Ricko Najmudin Facial Recognition">
  ...
  },
  {
    ...
    html: `
			<div class="finland-map-wrap">
				<img class="finland-map" src="${imagePath}/finland-map.svg" alt="bandung map">
  ...
  },
  {
    ...
    html: `
        <div class="profile">
            <div class="profile-image"><img src="${imagePath}/micki.jpg" width="100%" alt="iki"></div>
            <div class="profile-info">
                <table>
                    <tbody>
                        <tr><td>Name</td><td>Mickey</td></tr>
                        <tr><td>Alias</td><td>iky</td></tr>
                        <tr><td>Profession</td><td>Friend</td></tr>
                        <tr><td>Sex</td><td>Male</td></tr>
                        <tr><td>Age</td><td>1.5</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        <div class="profile">
            <div class="profile-image"><img src="${imagePath}/zoro.jpg" width="100%" alt="zoro"></div>
            <div class="profile-info">
                <table>
                    <tbody>
                        <tr><td>Name</td><td>Zoro</td></tr>
                        <tr><td>Alias</td><td>ORO</td></tr>
                        <tr><td>Profession</td><td>Friend</td></tr>
                        <tr><td>Sex</td><td>Male</td></tr>
...

  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://www.investing.com/">Investing.com</a></td><td>Bandung, Indonesia</td><td>2023 - Present</td><td><a href="#" onclick="modal(event)" data-title="Investing">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://www.exness.com/id/">Exness</a></td><td>Bandung, Indonesia</td><td>2019 - Present</td><td><a href="#" onclick="modal(event)" data-title="Exnnes">Full Report</a></td></tr>
					<tr><td>Freelance</td><td>Remote</td><td>2015 - Present</td><td><a href="#" onclick="modal(event)" data-title="Freelance">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  {
    ...
    html: `<table>
          ...
          <td>2016-2020</td>
          <td>S.T. (Sarjana Teknik)</td>
        </tr>
        <tr>
          <td>Cisco</td>
          <td>2017</td>
          <td>Cisco Sertified Network Associate</td>
        </tr>
			</tbody>
		</table>`,
  },
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Ricko" -lastName "Najmudin"',
        typing: true,
      },
      {
        text: "loading...",

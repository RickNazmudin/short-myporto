...
var cards = [
  ...
  },
  {
    ...
    html: `
			<div class="finland-map-wrap">
				<img class="finland-map" src="${imagePath}/findland-map.svg" alt="bandung map">
  ...
  },
  {
    ...
    width: 240,
    html: `<div class="profile-image"><img src="${imagePath}/micki.jpg" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Mickey</td></tr>
					<tr><td>Alias</td><td>iki</td></tr>
